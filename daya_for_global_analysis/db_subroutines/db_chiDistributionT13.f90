subroutine db_chiDistributionT13(n)
    ...
    integer :: i,j
    real(8) :: t_jump
    real(8) :: t_0=asin(sqrt(0.05))/2.0d0!0.1288985016d0   ! t_0= 0.112756703d0   asin(sqrt(0.045d0))/2.0d0
    real(8) :: t_1=asin(sqrt(0.15))/2.0d0!0.180649968323d0      !0.198849708d0!0.785398163d0    asin(sqrt(0.15d0))/2.0d0!
    real(8) :: sen2_2t_13
    ...
    open(90, file='db_data/db_data_min_parameters.dat',status='old')
        read(90,*,IOSTAT=reason) readminResults
    close(90)

    open(194, file='db_data/db_distribution_chi_t13.dat')
    open(195, file='db_data/db_distribution_chi_t13_min.dat')
    ...
    open(91,file='db_data/db_distribution_chi_t13_min.dat',status='old')
        read(91,*) minT13
    close(91)
    open(92,file='db_data/db_distribution_chi_t13.dat',status='old')
        read(92,*) ((valuesT13(i,j), j=1,2), i=1,n+1)
    close(92)

    open(196,file='db_data/db_distribution_chi_t13.dat',status='old')
        do i=1,n+1
    ...
    close(196)
    open(181,file='db_data/db_t13_uncertainty.dat')
