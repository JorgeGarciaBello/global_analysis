subroutine db_generate_weight_w_systematic_array(t13,dmee,rand_w_i)
    ...
    do i=1,156        
        do k=1,num_experiments
            !rand_w_i(i,k)=(db_cov_M_expected_antineutrino_number_far_bin(i,k,t13,dmee)+bkg_t_N_f(i))/ &
            !              (db_cov_M_expected_antineutrino_number_near_bin(i,k,t13,dmee)+bkg_t_N_n(i))
            ...
            !rand_w_i(i,k)=db_cov_M_expected_antineutrino_number_far_bin(i,k,t13,dmee)/ &
            !              db_cov_M_expected_antineutrino_number_near_bin(i,k,t13,dmee)
        enddo        
    enddo
    !$omp end parallel do
    return
