subroutine makeFakeData()
    ...
    t12=0.5837630476d0
    t13=0.1484591652d0                  !########## Parámetro de ocilación impuesto para generar FAKE-DATA  ########### se tomma del paper de 2018
    t14=0.0d0
    ...
    dm21=7.53D-5
    dm31=2.5220d-3                  !########## Parámetro de ocilación impuesto para generar FAKE-DATA ###########3
    dm41=0.0d0   

    open(201,file='daya_for_global_analysis/db_data/fake_data_2019_spectrum_maked_by_detector.dat')
    do d=1,8
