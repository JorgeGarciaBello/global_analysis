...
file1 = fopen('xmgrace_sigma_Tpower_test_mod_percentage_1_all_bin.dat', 'w');
fprintf(file1,'%d %d %d \n' ,data1);
fclose(file1);
file1 = fopen('xmgrace_sigma_Tpower_test_mod_percentage_2_all_bin.dat', 'w');
fprintf(file1,'%d %d %d \n' ,data2);
fclose(file1);
file1 = fopen('xmgrace_sigma_Tpower_test_mod_percentage_3_all_bin.dat', 'w');
fprintf(file1,'%d %d %d \n' ,data3);
fclose(file1);
file1 = fopen('xmgrace_sigma_Tpower_test_mod_percentage_4_all_bin.dat', 'w');
fprintf(file1,'%d %d %d \n' ,data4);
fclose(file1);
file1 = fopen('xmgrace_sigma_Tpower_test_mod_percentage_5_all_bin.dat', 'w');
fprintf(file1,'%d %d %d \n' ,data5);
fclose(file1);
file1 = fopen('xmgrace_sigma_Tpower_test_mod_percentage_6_all_bin.dat', 'w');
fprintf(file1,'%d %d %d \n' ,data6);
fclose(file1);

file1 = fopen('xmgrace_sigma_Tpower_test_mod_percentage_7_all_bin.dat', 'w');
fprintf(file1,'%d %d %d \n' ,data7);
fclose(file1);
file1 = fopen('xmgrace_sigma_Tpower_test_mod_percentage_8_all_bin.dat', 'w');
fprintf(file1,'%d %d %d \n' ,data8);
fclose(file1);
