program main_global
    ...
    !call makeFakeData()
    !stop   
    !call db_chiDistributionDmee(500)
    !print*,'Terminaron las db_chiDistribution'
    ...
    Y=0.0
    dm_min=2.105d-3        ! 2.105d-3
    dm_max=2.805d-3        ! 2.805d-3

    t13_min=0.1288985016d0!0.16d0 !0.08d0      ! 0.1288985016
    t13_max=0.18d0   !0.19d0       ! 0.1649968323d0
