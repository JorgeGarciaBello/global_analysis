subroutine DC_create_M_stat_signal_bkg(t13,dmee,U,V,e_a,e_b,e_c)
    use types
    ...
    integer  :: i,j
    real(dp) :: e_a,e_b,e_c
    call DC_generate_vectors_U(t13,dmee,Nbar_i,U,e_a,e_b,e_c)
    do i=1,NBIN
        do j=1,NBIN
            V(i,j)=DC_M_Total_ij(t13,dmee,i,j,Nbar_i,U)
        enddo
    enddo
